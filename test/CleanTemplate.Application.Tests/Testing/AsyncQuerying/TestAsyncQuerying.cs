...
namespace CleanTemplate.Application.Tests.Testing.AsyncQuerying;

internal sealed class TestAsyncQueryProvider<TEntity> : IAsyncQueryProvider, IQueryProvider
{
    ...
    public TResult ExecuteAsync<TResult>(Expression expression, CancellationToken cancellationToken = default)
    {
        ...
        var fromResultMethod = typeof(Task)
            .GetMethods()
            .Single(m => m.Name == nameof(Task.FromResult) && m.ContainsGenericParameters)
